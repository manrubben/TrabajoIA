...
1. DataFrame a usar. En el caso de que se quieran usar nuevos datasets, se recomienda meterlos en la carpeta "docs" y posteriormente convertirlo 
en DataFrame con la funcion pandas.read_csv.
